...
namespace FurnitureFactoryWeb.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public MaterialsController(FurnitureFactoryContext context)
        {
            _context = context;
        }
        ...
        {
            var furnitureFactoryContext = _context.Materials.Include(m => m.Provider);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ProviderId")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ProviderId")] Material material)
        {
            if (id != material.Id)
            {
                return NotFound();
