...
namespace FurnitureFactoryWeb.Controllers
{
    public class FurnituresController : Controller
    {
        ...
        public FurnituresController(FurnitureFactoryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Price,Number")] Furniture furniture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,Number")] Furniture furniture)
        {
            if (id != furniture.Id)
            {
                return NotFound();
